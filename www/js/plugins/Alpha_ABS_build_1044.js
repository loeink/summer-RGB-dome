 ...
 * @plugindesc v1.2.1044 [Basic] The real-time action battle system
 * 
 * @help
 * 
 * Web Page: 
...
(function () {
    ...
    (function () {
        ...
        _.InitSession = function () {
            ...
            _.Log("Alpha ABS version", AlphaABS.Version);
...
(function() {
  ...
  //?[FROM ATBS]
  DefaultKeyConfig = ['w', 'd', 's', 'a', 'e', 'q', 'w', 'd', 's', 'a', '1', '2', '3', '4', '5', '6', '7', '8', 'r', 'f', 'control'];
...
(function () {
  ...
  BattleManagerABS._nearestTargetForPlayer = function (isExclusive) {
    ...
    var candidates = ABSUtils.inRadius($gamePlayer, 12, $gameTroop.membersABS());
...
(function() {
  ...
  _._getSettingsById = function(id, name) {
    ...
    return AA.criticalError(new Error('ID not found!'), id + ' not found in ' + name + '.json');
  };
  ...
  _._loadKeyBinding = function() {
    ...
    return AA.LIBS.IKey.loadKeyConfig(keys);
  };
...
(function() {
  ...
  AASpelllPanelManager = class AASpelllPanelManager {
    ...
    _createThread() {
      return this._thread = setInterval((() => {
        this._updateSkillsState();
      }), this.settings.threadUpdateMS);
    }

    _createThread2() {
      return this._thread2 = setInterval((() => {
        this._updateInfo();
...
ButtonsProManager.loadABS = function() {
  ...
  return ButtonsProManager.createButton('attack');
};

//TODO: Special behaviour for Attack button
...
(function () {
  ...
  //@[ALIAS]
  var _alias_Game_Actor_addNewState = Game_Actor.prototype.addNewState;
  Game_Actor.prototype.addNewState = function (stateId) {
    _alias_Game_Actor_addNewState.call(this, ...arguments);
    if (this.isPlayer()) {
...
(function () {
  ...
  Game_Player.prototype._update_input = function () {
    ...
    if (this._absParams.inputMode == 0) {
      ...
      if (Input.isTriggered(AlphaABS.LIBS.IKey.TN())){
      ...
      if (Input.isPressed(AlphaABS.LIBS.IKey.AR())) {
        if (this.canMove()) {
          if (!this._absParams.targetFollowMode) {
            if (!Utils.isMobileDevice()) {
              this.turnTowardCharacter(SMouse.getMousePosition().convertToMap());
...
(function () {
    ...
    Scene_Map.prototype.create = function () {
        ...
        this.sceneButtonSystem = new AlphaABS.LIBS.SceneButtonSystem(this);
...
(function() {
  ...
  SpriteUIElement = class SpriteUIElement extends AASprite {
    ...
    _loadSettings() {
      this.settings = AA.JSON.getUIElementSettings(this.id);
...
(function() {
  ...
  Spriteset_InterfaceABS.prototype._createUI13EnemyUI = function(target) {
    ...
    if (target.behaviorModel().faceName != null) {
...
AlphaABS.getVersionInfo = function() {
  return AlphaABS.Version + " build " + AlphaABS.Build + " on MV " + Utils.RPGMAKER_VERSION;
};
...
//Plugin Alpha_ABS automatic build by MVPluginBuilder 1.6.2 15.05.2019
